...
public class dadosJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPLETE TODOS OS DADOS PARA SALVAR");

        BtOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/vrc (1).png"))); // NOI18N
        BtOk1.setText("Ok");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dadosJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
